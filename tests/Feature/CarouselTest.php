...
it(description: 'can render carousel item images', closure: function () {
    $view = $this->blade(template: '<x-carousel-item image-src="burger.webp" image-alt="Burger" />');
...
it(description: 'can render carousel item images with slot content', closure: function () {
    $view = $this->blade(template: '<x-carousel-item image-src="burger.webp" image-alt="Burger"><a href="#next">Next</a></x-carousel-item>');
...
it(description: 'can render carousel direction and modifier attributes', closure: function () {
    $view = $this->blade(template: '<x-carousel direction="vertical" modifier="center">Content</x-carousel>');
...
it(description: 'ignores invalid carousel direction and modifier attributes', closure: function () {
    $view = $this->blade(template: '<x-carousel direction="diagonal" modifier="between">Content</x-carousel>');
