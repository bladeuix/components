...
it(description: 'can render table cell with custom classes and attributes', closure: function () {
    $view = $this->blade(template: '<x-table-cell data-label="name" class="font-bold">Cy Ganderton</x-table-cell>');
...
it(description: 'can render table cell with value prop', closure: function () {
    $view = $this->blade(template: '<x-table-cell value="Cy Ganderton"></x-table-cell>');
...
it(description: 'can render table cell with html slot content', closure: function () {
    $view = $this->blade(template: '<x-table-cell><span class="font-bold">Cy Ganderton</span></x-table-cell>');
...
it(description: 'prefers table cell value prop over slot content', closure: function () {
    $view = $this->blade(template: '<x-table-cell value="Cy Ganderton">Ignored</x-table-cell>');
