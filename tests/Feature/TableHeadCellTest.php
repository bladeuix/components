...
it(description: 'can render table head cell with custom classes and attributes', closure: function () {
    $view = $this->blade(template: '<x-daisyui::table-head-cell scope="col" class="text-primary">Name</x-daisyui::table-head-cell>');
...
it(description: 'can render table head cell with value prop', closure: function () {
    $view = $this->blade(template: '<x-daisyui::table-head-cell value="Name"></x-daisyui::table-head-cell>');
...
it(description: 'can render table head cell with html slot content', closure: function () {
    $view = $this->blade(template: '<x-daisyui::table-head-cell><span class="font-bold">Name</span></x-daisyui::table-head-cell>');
...
it(description: 'prefers table head cell value prop over slot content', closure: function () {
    $view = $this->blade(template: '<x-daisyui::table-head-cell value="Name">Ignored</x-daisyui::table-head-cell>');
