...
<x-daisyui::badge color="accent">Accent</x-daisyui::badge>
<x-daisyui::badge color="neutral">Neutral</x-daisyui::badge>
...
<x-daisyui::badge variant="soft" color="accent">Accent</x-daisyui::badge>
...
<x-daisyui::badge variant="outline" color="accent">Accent</x-daisyui::badge>
...
<x-daisyui::badge variant="dash" color="accent">Accent</x-daisyui::badge>
...
<h1 class="text-xl font-semibold">
    Heading 1
    <x-daisyui::badge size="xl">Badge</x-daisyui::badge>
</h1>

<h2 class="text-lg font-semibold">
    Heading 2
    <x-daisyui::badge size="lg">Badge</x-daisyui::badge>
</h2>
